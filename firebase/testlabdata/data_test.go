...
import (
	...
	"github.com/googleapis/google-cloudevents-go/firebase/testlabdata"
...
func TestParsingTestMatrixEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "TestMatrixEventData", "google/events/firebase/testlab/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := testlabdata.TestMatrixEventData{}
