...
package firebasealertsdata_test
...
import (
	...
	"github.com/googleapis/google-cloudevents-go/firebase/firebasealertsdata"
...
func TestParsingAlertData(t *testing.T) {
	cases := testhelper.FindTestData(t, "AlertData", "google/events/firebase/firebasealerts/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := firebasealertsdata.AlertData{}
