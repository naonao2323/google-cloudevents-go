...
import (
	...
	"github.com/googleapis/google-cloudevents-go/firebase/analyticsdata"
...
func TestParsingAnalyticsLogData(t *testing.T) {
	cases := testhelper.FindTestData(t, "AnalyticsLogData", "google/events/firebase/analytics/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := analyticsdata.AnalyticsLogData{}
