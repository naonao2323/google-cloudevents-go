...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/schedulerdata"
...
func TestParsingJobEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "JobEventData", "google/events/cloud/scheduler/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := schedulerdata.JobEventData{}
...
//   - no deleted or renamed fields in protos covered in test data
//   - test data does not carry unknown fields
func TestParsingSchedulerJobData(t *testing.T) {
	cases := testhelper.FindTestData(t, "SchedulerJobData", "google/events/cloud/scheduler/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := schedulerdata.SchedulerJobData{}
				pj := protojson.UnmarshalOptions{DiscardUnknown: true}
				if err := pj.Unmarshal(data, &out); err != nil {
					t.Fatalf("protojson.Unmarshal: could not parse %q\n----%s\n----", file, data)
				}
