...
func TestParsingDocumentEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "DocumentEventData", "google/events/cloud/firestore/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := firestoredata.DocumentEventData{}
