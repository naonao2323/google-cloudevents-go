...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/memcachedata"
...
func TestParsingInstanceEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "InstanceEventData", "google/events/cloud/memcache/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := memcachedata.InstanceEventData{}
