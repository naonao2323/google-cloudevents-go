...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/workflowsdata"
...
func TestParsingWorkflowEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "WorkflowEventData", "google/events/cloud/workflows/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := workflowsdata.WorkflowEventData{}
