...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/alloydbdata"
...
func TestParsingBackupEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "BackupEventData", "google/events/cloud/alloydb/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := alloydbdata.BackupEventData{}
...
func TestParsingClusterEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "ClusterEventData", "google/events/cloud/alloydb/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := alloydbdata.ClusterEventData{}
				pj := protojson.UnmarshalOptions{DiscardUnknown: true}
				if err := pj.Unmarshal(data, &out); err != nil {
					t.Fatalf("protojson.Unmarshal: could not parse %q\n----%s\n----", file, data)
				}
...
func TestParsingInstanceEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "InstanceEventData", "google/events/cloud/alloydb/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := alloydbdata.InstanceEventData{}
				pj := protojson.UnmarshalOptions{DiscardUnknown: true}
				if err := pj.Unmarshal(data, &out); err != nil {
					t.Fatalf("protojson.Unmarshal: could not parse %q\n----%s\n----", file, data)
				}
