...
func TestParsingStorageObjectData(t *testing.T) {
	cases := testhelper.FindTestData(t, "StorageObjectData", "google/events/cloud/storage/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := storagedata.StorageObjectData{}
