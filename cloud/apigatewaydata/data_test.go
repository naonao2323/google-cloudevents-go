...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/apigatewaydata"
...
func TestParsingApiConfigEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "ApiConfigEventData", "google/events/cloud/apigateway/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := apigatewaydata.ApiConfigEventData{}
...
func TestParsingApiEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "ApiEventData", "google/events/cloud/apigateway/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := apigatewaydata.ApiEventData{}
				pj := protojson.UnmarshalOptions{DiscardUnknown: true}
				if err := pj.Unmarshal(data, &out); err != nil {
					t.Fatalf("protojson.Unmarshal: could not parse %q\n----%s\n----", file, data)
				}
...
func TestParsingGatewayEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "GatewayEventData", "google/events/cloud/apigateway/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := apigatewaydata.GatewayEventData{}
				pj := protojson.UnmarshalOptions{DiscardUnknown: true}
				if err := pj.Unmarshal(data, &out); err != nil {
					t.Fatalf("protojson.Unmarshal: could not parse %q\n----%s\n----", file, data)
				}
