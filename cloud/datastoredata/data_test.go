...
func TestParsingEntityEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "EntityEventData", "google/events/cloud/datastore/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := datastoredata.EntityEventData{}
