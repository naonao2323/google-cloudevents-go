...
// 	protoc        v3.21.6
// source: cloud/iot/v1/data.proto
...
func (MqttState) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_iot_v1_data_proto_enumTypes[0].Descriptor()
}

func (MqttState) Type() protoreflect.EnumType {
	return &file_cloud_iot_v1_data_proto_enumTypes[0]
}
...
func (MqttState) EnumDescriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{0}
}
...
func (HttpState) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_iot_v1_data_proto_enumTypes[1].Descriptor()
}

func (HttpState) Type() protoreflect.EnumType {
	return &file_cloud_iot_v1_data_proto_enumTypes[1]
}
...
func (HttpState) EnumDescriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{1}
}
...
func (LogLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_iot_v1_data_proto_enumTypes[2].Descriptor()
}

func (LogLevel) Type() protoreflect.EnumType {
	return &file_cloud_iot_v1_data_proto_enumTypes[2]
}
...
func (LogLevel) EnumDescriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{2}
}
...
func (GatewayType) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_iot_v1_data_proto_enumTypes[3].Descriptor()
}

func (GatewayType) Type() protoreflect.EnumType {
	return &file_cloud_iot_v1_data_proto_enumTypes[3]
}
...
func (GatewayType) EnumDescriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{3}
}
...
func (GatewayAuthMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_iot_v1_data_proto_enumTypes[4].Descriptor()
}

func (GatewayAuthMethod) Type() protoreflect.EnumType {
	return &file_cloud_iot_v1_data_proto_enumTypes[4]
}
...
func (GatewayAuthMethod) EnumDescriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{4}
}
...
func (PublicKeyCertificateFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_iot_v1_data_proto_enumTypes[5].Descriptor()
}

func (PublicKeyCertificateFormat) Type() protoreflect.EnumType {
	return &file_cloud_iot_v1_data_proto_enumTypes[5]
}
...
func (PublicKeyCertificateFormat) EnumDescriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{5}
}
...
func (PublicKeyFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_cloud_iot_v1_data_proto_enumTypes[6].Descriptor()
}

func (PublicKeyFormat) Type() protoreflect.EnumType {
	return &file_cloud_iot_v1_data_proto_enumTypes[6]
}
...
func (PublicKeyFormat) EnumDescriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{6}
}
...
type Device struct {
	...
	LogLevel LogLevel `protobuf:"varint,21,opt,name=log_level,json=logLevel,proto3,enum=google.events.cloud.iot.v1.LogLevel" json:"log_level,omitempty"`
...
func (x *Device) Reset() {
	*x = Device{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[0]
...
type GatewayConfig struct {
	...
	GatewayType GatewayType `protobuf:"varint,1,opt,name=gateway_type,json=gatewayType,proto3,enum=google.events.cloud.iot.v1.GatewayType" json:"gateway_type,omitempty"`
	// Indicates how to authorize and/or authenticate devices to access the
	// gateway.
	GatewayAuthMethod GatewayAuthMethod `protobuf:"varint,2,opt,name=gateway_auth_method,json=gatewayAuthMethod,proto3,enum=google.events.cloud.iot.v1.GatewayAuthMethod" json:"gateway_auth_method,omitempty"`
...
func (x *GatewayConfig) Reset() {
	*x = GatewayConfig{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type DeviceRegistry struct {
	...
	LogLevel LogLevel `protobuf:"varint,11,opt,name=log_level,json=logLevel,proto3,enum=google.events.cloud.iot.v1.LogLevel" json:"log_level,omitempty"`
...
func (x *DeviceRegistry) Reset() {
	*x = DeviceRegistry{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type MqttConfig struct {
	...
	MqttEnabledState MqttState `protobuf:"varint,1,opt,name=mqtt_enabled_state,json=mqttEnabledState,proto3,enum=google.events.cloud.iot.v1.MqttState" json:"mqtt_enabled_state,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *MqttConfig) Reset() {
	*x = MqttConfig{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type HttpConfig struct {
	...
	HttpEnabledState HttpState `protobuf:"varint,1,opt,name=http_enabled_state,json=httpEnabledState,proto3,enum=google.events.cloud.iot.v1.HttpState" json:"http_enabled_state,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *HttpConfig) Reset() {
	*x = HttpConfig{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EventNotificationConfig) Reset() {
	*x = EventNotificationConfig{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *StateNotificationConfig) Reset() {
	*x = StateNotificationConfig{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *RegistryCredential) Reset() {
	*x = RegistryCredential{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegistryCredential) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{7}
}

func (x *RegistryCredential) GetCredential() isRegistryCredential_Credential {
	if x != nil {
		return x.Credential
	}
	return nil
...
func (x *RegistryCredential) GetPublicKeyCertificate() *PublicKeyCertificate {
	if x != nil {
		if x, ok := x.Credential.(*RegistryCredential_PublicKeyCertificate); ok {
...
func (x *X509CertificateDetails) Reset() {
	*x = X509CertificateDetails{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*X509CertificateDetails) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{8}
}
...
func (x *PublicKeyCertificate) Reset() {
	*x = PublicKeyCertificate{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublicKeyCertificate) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{9}
}
...
func (x *DeviceCredential) Reset() {
	*x = DeviceCredential{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeviceCredential) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{10}
}

func (x *DeviceCredential) GetCredential() isDeviceCredential_Credential {
	if x != nil {
		return x.Credential
	}
	return nil
...
func (x *DeviceCredential) GetPublicKey() *PublicKeyCredential {
	if x != nil {
		if x, ok := x.Credential.(*DeviceCredential_PublicKey); ok {
			return x.PublicKey
		}
	}
	return nil
...
func (x *PublicKeyCredential) Reset() {
	*x = PublicKeyCredential{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublicKeyCredential) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{11}
}
...
func (x *DeviceConfig) Reset() {
	*x = DeviceConfig{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeviceConfig) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{12}
}
...
func (x *DeviceState) Reset() {
	*x = DeviceState{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeviceState) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{13}
}
...
func (x *DeviceEventData) Reset() {
	*x = DeviceEventData{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeviceEventData) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{14}
}
...
func (x *RegistryEventData) Reset() {
	*x = RegistryEventData{}
	mi := &file_cloud_iot_v1_data_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegistryEventData) Descriptor() ([]byte, []int) {
	return file_cloud_iot_v1_data_proto_rawDescGZIP(), []int{15}
}
...
const file_cloud_iot_v1_data_proto_rawDesc = "" +
	"\n" +
	"\x17cloud/iot/v1/data.proto\x12\x1agoogle.events.cloud.iot.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\xc2\b\n" +
	"\x06Device\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x15\n" +
	"\x06num_id\x18\x03 \x01(\x04R\x05numId\x12N\n" +
	"\vcredentials\x18\f \x03(\v2,.google.events.cloud.iot.v1.DeviceCredentialR\vcredentials\x12J\n" +
	"\x13last_heartbeat_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x11lastHeartbeatTime\x12B\n" +
	"\x0flast_event_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\rlastEventTime\x12B\n" +
	"\x0flast_state_time\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampR\rlastStateTime\x12K\n" +
	"\x14last_config_ack_time\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampR\x11lastConfigAckTime\x12M\n" +
	"\x15last_config_send_time\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\x12lastConfigSendTime\x12\x18\n" +
	"\ablocked\x18\x13 \x01(\bR\ablocked\x12B\n" +
	"\x0flast_error_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\rlastErrorTime\x12>\n" +
	"\x11last_error_status\x18\v \x01(\v2\x12.google.rpc.StatusR\x0flastErrorStatus\x12@\n" +
	"\x06config\x18\r \x01(\v2(.google.events.cloud.iot.v1.DeviceConfigR\x06config\x12=\n" +
	"\x05state\x18\x10 \x01(\v2'.google.events.cloud.iot.v1.DeviceStateR\x05state\x12A\n" +
	"\tlog_level\x18\x15 \x01(\x0e2$.google.events.cloud.iot.v1.LogLevelR\blogLevel\x12L\n" +
	"\bmetadata\x18\x11 \x03(\v20.google.events.cloud.iot.v1.Device.MetadataEntryR\bmetadata\x12P\n" +
	"\x0egateway_config\x18\x18 \x01(\v2).google.events.cloud.iot.v1.GatewayConfigR\rgatewayConfig\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xcc\x02\n" +
	"\rGatewayConfig\x12J\n" +
	"\fgateway_type\x18\x01 \x01(\x0e2'.google.events.cloud.iot.v1.GatewayTypeR\vgatewayType\x12]\n" +
	"\x13gateway_auth_method\x18\x02 \x01(\x0e2-.google.events.cloud.iot.v1.GatewayAuthMethodR\x11gatewayAuthMethod\x127\n" +
	"\x18last_accessed_gateway_id\x18\x03 \x01(\tR\x15lastAccessedGatewayId\x12W\n" +
	"\x1alast_accessed_gateway_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x17lastAccessedGatewayTime\"\xbf\x04\n" +
	"\x0eDeviceRegistry\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12q\n" +
	"\x1aevent_notification_configs\x18\n" +
	" \x03(\v23.google.events.cloud.iot.v1.EventNotificationConfigR\x18eventNotificationConfigs\x12o\n" +
	"\x19state_notification_config\x18\a \x01(\v23.google.events.cloud.iot.v1.StateNotificationConfigR\x17stateNotificationConfig\x12G\n" +
	"\vmqtt_config\x18\x04 \x01(\v2&.google.events.cloud.iot.v1.MqttConfigR\n" +
	"mqttConfig\x12G\n" +
	"\vhttp_config\x18\t \x01(\v2&.google.events.cloud.iot.v1.HttpConfigR\n" +
	"httpConfig\x12A\n" +
	"\tlog_level\x18\v \x01(\x0e2$.google.events.cloud.iot.v1.LogLevelR\blogLevel\x12P\n" +
	"\vcredentials\x18\b \x03(\v2..google.events.cloud.iot.v1.RegistryCredentialR\vcredentials\"a\n" +
	"\n" +
	"MqttConfig\x12S\n" +
	"\x12mqtt_enabled_state\x18\x01 \x01(\x0e2%.google.events.cloud.iot.v1.MqttStateR\x10mqttEnabledState\"a\n" +
	"\n" +
	"HttpConfig\x12S\n" +
	"\x12http_enabled_state\x18\x01 \x01(\x0e2%.google.events.cloud.iot.v1.HttpStateR\x10httpEnabledState\"r\n" +
	"\x17EventNotificationConfig\x12+\n" +
	...
	"\x11pubsub_topic_name\x18\x01 \x01(\tR\x0fpubsubTopicName\"\x8c\x01\n" +
	"\x12RegistryCredential\x12h\n" +
	"\x16public_key_certificate\x18\x01 \x01(\v20.google.events.cloud.iot.v1.PublicKeyCertificateH\x00R\x14publicKeyCertificateB\f\n" +
	"\n" +
	"credential\"\x9b\x02\n" +
	...
	"\x0fpublic_key_type\x18\x06 \x01(\tR\rpublicKeyType\"\xdf\x01\n" +
	"\x14PublicKeyCertificate\x12N\n" +
	"\x06format\x18\x01 \x01(\x0e26.google.events.cloud.iot.v1.PublicKeyCertificateFormatR\x06format\x12 \n" +
	"\vcertificate\x18\x02 \x01(\tR\vcertificate\x12U\n" +
	"\fx509_details\x18\x03 \x01(\v22.google.events.cloud.iot.v1.X509CertificateDetailsR\vx509Details\"\xb7\x01\n" +
	"\x10DeviceCredential\x12P\n" +
	"\n" +
	"public_key\x18\x02 \x01(\v2/.google.events.cloud.iot.v1.PublicKeyCredentialH\x00R\tpublicKey\x12C\n" +
	"\x0fexpiration_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x0eexpirationTimeB\f\n" +
	"\n" +
	"credential\"l\n" +
	"\x13PublicKeyCredential\x12C\n" +
	"\x06format\x18\x01 \x01(\x0e2+.google.events.cloud.iot.v1.PublicKeyFormatR\x06format\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\"\xd5\x01\n" +
	"\fDeviceConfig\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x03R\aversion\x12F\n" +
	"\x11cloud_update_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x0fcloudUpdateTime\x12B\n" +
	"\x0fdevice_ack_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\rdeviceAckTime\x12\x1f\n" +
	...
	"binaryData\"`\n" +
	"\x0fDeviceEventData\x12A\n" +
	"\apayload\x18\x01 \x01(\v2\".google.events.cloud.iot.v1.DeviceH\x00R\apayload\x88\x01\x01B\n" +
	"\n" +
	"\b_payload\"j\n" +
	"\x11RegistryEventData\x12I\n" +
	"\apayload\x18\x01 \x01(\v2*.google.events.cloud.iot.v1.DeviceRegistryH\x00R\apayload\x88\x01\x01B\n" +
	"\n" +
	"\b_payload*L\n" +
	"\tMqttState\x12\x1a\n" +
	"\x16MQTT_STATE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fMQTT_ENABLED\x10\x01\x12\x11\n" +
	"\rMQTT_DISABLED\x10\x02*L\n" +
	"\tHttpState\x12\x1a\n" +
	"\x16HTTP_STATE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fHTTP_ENABLED\x10\x01\x12\x11\n" +
	"\rHTTP_DISABLED\x10\x02*O\n" +
	"\bLogLevel\x12\x19\n" +
	"\x15LOG_LEVEL_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04NONE\x10\n" +
	"\x12\t\n" +
	"\x05ERROR\x10\x14\x12\b\n" +
	"\x04INFO\x10\x1e\x12\t\n" +
	"\x05DEBUG\x10(*I\n" +
	"\vGatewayType\x12\x1c\n" +
	"\x18GATEWAY_TYPE_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aGATEWAY\x10\x01\x12\x0f\n" +
	"\vNON_GATEWAY\x10\x02*\x91\x01\n" +
	...
	"\x1dUNSPECIFIED_PUBLIC_KEY_FORMAT\x10\x00\x12\v\n" +
	"\aRSA_PEM\x10\x03\x12\x10\n" +
	"\fRSA_X509_PEM\x10\x01\x12\r\n" +
	"\tES256_PEM\x10\x02\x12\x12\n" +
	"\x0eES256_X509_PEM\x10\x04Bd\xaa\x02#Google.Events.Protobuf.Cloud.Iot.V1\xca\x02\x1aGoogle\\Events\\Cloud\\Iot\\V1\xea\x02\x1eGoogle::Events::Cloud::Iot::V1b\x06proto3"

var (
	file_cloud_iot_v1_data_proto_rawDescOnce sync.Once
	file_cloud_iot_v1_data_proto_rawDescData []byte
)

func file_cloud_iot_v1_data_proto_rawDescGZIP() []byte {
	file_cloud_iot_v1_data_proto_rawDescOnce.Do(func() {
		file_cloud_iot_v1_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cloud_iot_v1_data_proto_rawDesc), len(file_cloud_iot_v1_data_proto_rawDesc)))
	})
	return file_cloud_iot_v1_data_proto_rawDescData
}

var file_cloud_iot_v1_data_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_cloud_iot_v1_data_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_cloud_iot_v1_data_proto_goTypes = []any{
	(MqttState)(0),                  // 0: google.events.cloud.iot.v1.MqttState
	(HttpState)(0),                  // 1: google.events.cloud.iot.v1.HttpState
	(LogLevel)(0),                   // 2: google.events.cloud.iot.v1.LogLevel
	(GatewayType)(0),                // 3: google.events.cloud.iot.v1.GatewayType
	(GatewayAuthMethod)(0),          // 4: google.events.cloud.iot.v1.GatewayAuthMethod
	(PublicKeyCertificateFormat)(0), // 5: google.events.cloud.iot.v1.PublicKeyCertificateFormat
	(PublicKeyFormat)(0),            // 6: google.events.cloud.iot.v1.PublicKeyFormat
	(*Device)(nil),                  // 7: google.events.cloud.iot.v1.Device
	(*GatewayConfig)(nil),           // 8: google.events.cloud.iot.v1.GatewayConfig
	(*DeviceRegistry)(nil),          // 9: google.events.cloud.iot.v1.DeviceRegistry
	(*MqttConfig)(nil),              // 10: google.events.cloud.iot.v1.MqttConfig
	(*HttpConfig)(nil),              // 11: google.events.cloud.iot.v1.HttpConfig
	(*EventNotificationConfig)(nil), // 12: google.events.cloud.iot.v1.EventNotificationConfig
	(*StateNotificationConfig)(nil), // 13: google.events.cloud.iot.v1.StateNotificationConfig
	(*RegistryCredential)(nil),      // 14: google.events.cloud.iot.v1.RegistryCredential
	(*X509CertificateDetails)(nil),  // 15: google.events.cloud.iot.v1.X509CertificateDetails
	(*PublicKeyCertificate)(nil),    // 16: google.events.cloud.iot.v1.PublicKeyCertificate
	(*DeviceCredential)(nil),        // 17: google.events.cloud.iot.v1.DeviceCredential
	(*PublicKeyCredential)(nil),     // 18: google.events.cloud.iot.v1.PublicKeyCredential
	(*DeviceConfig)(nil),            // 19: google.events.cloud.iot.v1.DeviceConfig
	(*DeviceState)(nil),             // 20: google.events.cloud.iot.v1.DeviceState
	(*DeviceEventData)(nil),         // 21: google.events.cloud.iot.v1.DeviceEventData
	(*RegistryEventData)(nil),       // 22: google.events.cloud.iot.v1.RegistryEventData
	nil,                             // 23: google.events.cloud.iot.v1.Device.MetadataEntry
	(*timestamppb.Timestamp)(nil),   // 24: google.protobuf.Timestamp
	(*status.Status)(nil),           // 25: google.rpc.Status
}
var file_cloud_iot_v1_data_proto_depIdxs = []int32{
	17, // 0: google.events.cloud.iot.v1.Device.credentials:type_name -> google.events.cloud.iot.v1.DeviceCredential
	24, // 1: google.events.cloud.iot.v1.Device.last_heartbeat_time:type_name -> google.protobuf.Timestamp
	24, // 2: google.events.cloud.iot.v1.Device.last_event_time:type_name -> google.protobuf.Timestamp
	24, // 3: google.events.cloud.iot.v1.Device.last_state_time:type_name -> google.protobuf.Timestamp
	24, // 4: google.events.cloud.iot.v1.Device.last_config_ack_time:type_name -> google.protobuf.Timestamp
	24, // 5: google.events.cloud.iot.v1.Device.last_config_send_time:type_name -> google.protobuf.Timestamp
	24, // 6: google.events.cloud.iot.v1.Device.last_error_time:type_name -> google.protobuf.Timestamp
	25, // 7: google.events.cloud.iot.v1.Device.last_error_status:type_name -> google.rpc.Status
	19, // 8: google.events.cloud.iot.v1.Device.config:type_name -> google.events.cloud.iot.v1.DeviceConfig
	20, // 9: google.events.cloud.iot.v1.Device.state:type_name -> google.events.cloud.iot.v1.DeviceState
	2,  // 10: google.events.cloud.iot.v1.Device.log_level:type_name -> google.events.cloud.iot.v1.LogLevel
	23, // 11: google.events.cloud.iot.v1.Device.metadata:type_name -> google.events.cloud.iot.v1.Device.MetadataEntry
	8,  // 12: google.events.cloud.iot.v1.Device.gateway_config:type_name -> google.events.cloud.iot.v1.GatewayConfig
	3,  // 13: google.events.cloud.iot.v1.GatewayConfig.gateway_type:type_name -> google.events.cloud.iot.v1.GatewayType
	4,  // 14: google.events.cloud.iot.v1.GatewayConfig.gateway_auth_method:type_name -> google.events.cloud.iot.v1.GatewayAuthMethod
	24, // 15: google.events.cloud.iot.v1.GatewayConfig.last_accessed_gateway_time:type_name -> google.protobuf.Timestamp
	12, // 16: google.events.cloud.iot.v1.DeviceRegistry.event_notification_configs:type_name -> google.events.cloud.iot.v1.EventNotificationConfig
	13, // 17: google.events.cloud.iot.v1.DeviceRegistry.state_notification_config:type_name -> google.events.cloud.iot.v1.StateNotificationConfig
	10, // 18: google.events.cloud.iot.v1.DeviceRegistry.mqtt_config:type_name -> google.events.cloud.iot.v1.MqttConfig
	11, // 19: google.events.cloud.iot.v1.DeviceRegistry.http_config:type_name -> google.events.cloud.iot.v1.HttpConfig
	2,  // 20: google.events.cloud.iot.v1.DeviceRegistry.log_level:type_name -> google.events.cloud.iot.v1.LogLevel
	14, // 21: google.events.cloud.iot.v1.DeviceRegistry.credentials:type_name -> google.events.cloud.iot.v1.RegistryCredential
	0,  // 22: google.events.cloud.iot.v1.MqttConfig.mqtt_enabled_state:type_name -> google.events.cloud.iot.v1.MqttState
	1,  // 23: google.events.cloud.iot.v1.HttpConfig.http_enabled_state:type_name -> google.events.cloud.iot.v1.HttpState
	16, // 24: google.events.cloud.iot.v1.RegistryCredential.public_key_certificate:type_name -> google.events.cloud.iot.v1.PublicKeyCertificate
	24, // 25: google.events.cloud.iot.v1.X509CertificateDetails.start_time:type_name -> google.protobuf.Timestamp
	24, // 26: google.events.cloud.iot.v1.X509CertificateDetails.expiry_time:type_name -> google.protobuf.Timestamp
	5,  // 27: google.events.cloud.iot.v1.PublicKeyCertificate.format:type_name -> google.events.cloud.iot.v1.PublicKeyCertificateFormat
	15, // 28: google.events.cloud.iot.v1.PublicKeyCertificate.x509_details:type_name -> google.events.cloud.iot.v1.X509CertificateDetails
	18, // 29: google.events.cloud.iot.v1.DeviceCredential.public_key:type_name -> google.events.cloud.iot.v1.PublicKeyCredential
	24, // 30: google.events.cloud.iot.v1.DeviceCredential.expiration_time:type_name -> google.protobuf.Timestamp
	6,  // 31: google.events.cloud.iot.v1.PublicKeyCredential.format:type_name -> google.events.cloud.iot.v1.PublicKeyFormat
	24, // 32: google.events.cloud.iot.v1.DeviceConfig.cloud_update_time:type_name -> google.protobuf.Timestamp
	24, // 33: google.events.cloud.iot.v1.DeviceConfig.device_ack_time:type_name -> google.protobuf.Timestamp
	24, // 34: google.events.cloud.iot.v1.DeviceState.update_time:type_name -> google.protobuf.Timestamp
	7,  // 35: google.events.cloud.iot.v1.DeviceEventData.payload:type_name -> google.events.cloud.iot.v1.Device
	9,  // 36: google.events.cloud.iot.v1.RegistryEventData.payload:type_name -> google.events.cloud.iot.v1.DeviceRegistry
...
func init() { file_cloud_iot_v1_data_proto_init() }
func file_cloud_iot_v1_data_proto_init() {
	if File_cloud_iot_v1_data_proto != nil {
		return
	}
	file_cloud_iot_v1_data_proto_msgTypes[7].OneofWrappers = []any{
		(*RegistryCredential_PublicKeyCertificate)(nil),
	}
	file_cloud_iot_v1_data_proto_msgTypes[10].OneofWrappers = []any{
		(*DeviceCredential_PublicKey)(nil),
	}
	file_cloud_iot_v1_data_proto_msgTypes[14].OneofWrappers = []any{}
	file_cloud_iot_v1_data_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cloud_iot_v1_data_proto_rawDesc), len(file_cloud_iot_v1_data_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cloud_iot_v1_data_proto_goTypes,
		DependencyIndexes: file_cloud_iot_v1_data_proto_depIdxs,
		EnumInfos:         file_cloud_iot_v1_data_proto_enumTypes,
		MessageInfos:      file_cloud_iot_v1_data_proto_msgTypes,
	}.Build()
	File_cloud_iot_v1_data_proto = out.File
	file_cloud_iot_v1_data_proto_goTypes = nil
	file_cloud_iot_v1_data_proto_depIdxs = nil
}
