...
package appconnectorsdata_test
...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/beyondcorp/appconnectorsdata"
...
func TestParsingAppConnectorEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "AppConnectorEventData", "google/events/cloud/beyondcorp/appconnectors/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := appconnectorsdata.AppConnectorEventData{}
