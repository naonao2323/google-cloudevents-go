...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/beyondcorp/appgatewaysdata"
...
func TestParsingAppGatewayEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "AppGatewayEventData", "google/events/cloud/beyondcorp/appgateways/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := appgatewaysdata.AppGatewayEventData{}
