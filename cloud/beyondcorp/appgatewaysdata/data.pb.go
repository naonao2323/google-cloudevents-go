...
const file_cloud_beyondcorp_appgateways_v1_data_proto_rawDesc = "" +
	"\n" +
	"*cloud/beyondcorp/appgateways/v1/data.proto\x12-google.events.cloud.beyondcorp.appgateways.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa2\t\n" +
	"\n" +
	"AppGateway\x12\x12\n" +
	...
	"\thost_type\x18\v \x01(\x0e2B.google.events.cloud.beyondcorp.appgateways.v1.AppGateway.HostTypeR\bhostType\x12(\n" +
	"\rsatisfies_pzs\x18\f \x01(\bH\x00R\fsatisfiesPzs\x88\x01\x01\x12(\n" +
	"\rsatisfies_pzi\x18\r \x01(\bH\x01R\fsatisfiesPzi\x88\x01\x01\x1aQ\n" +
	...
	"\x10GCP_REGIONAL_MIG\x10\x01B\x10\n" +
...
func file_cloud_beyondcorp_appgateways_v1_data_proto_init() {
	...
	file_cloud_beyondcorp_appgateways_v1_data_proto_msgTypes[0].OneofWrappers = []any{}
