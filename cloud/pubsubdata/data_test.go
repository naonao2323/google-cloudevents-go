...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/pubsubdata"
...
func TestParsingMessagePublishedData(t *testing.T) {
	cases := testhelper.FindTestData(t, "MessagePublishedData", "google/events/cloud/pubsub/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("compatibility", func(t *testing.T) {
				cleanData, err := testhelper.PreparePubSubMessagePublishedData(data)
				if err != nil {
