...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/redisdata"
...
func TestParsingInstanceEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "InstanceEventData", "google/events/cloud/redis/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := redisdata.InstanceEventData{}
