...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/functionsdatav2"
...
func TestParsingFunctionEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "FunctionEventData", "google/events/cloud/functions/v2")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := functionsdatav2.FunctionEventData{}
